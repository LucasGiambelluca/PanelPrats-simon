        ...
        <div className="p-4 border-b border-brand-hairline">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white border border-brand-hairline text-brand-ink text-xs rounded-xl pl-9 pr-3 py-2.5 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3b6fe0]/40 transition-all"
            />
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`w-full text-left px-4 py-3.5 transition-all duration-150 flex items-center gap-3 ${
                  isActive
                    ? 'bg-[#3b6fe0]/10 border-l-2 border-l-[#3b6fe0]'
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  <div className={`w-11 h-11 rounded-full flex items-center justify-center ${
                    isActive
                      ? 'bg-[#3b6fe0]/20 border border-[#3b6fe0]/30'
                      : 'bg-black/[0.03] border border-brand-hairline'
                  }`}>
                    <span className={`text-xs font-bold ${isActive ? 'text-[#3b6fe0]' : 'text-brand-inkmuted'}`}>
        ...
        {activeConvo ? (
          <>
            ...
            <div className="px-4 lg:px-6 py-3.5 border-b border-brand-hairline flex items-center justify-between bg-brand-surface backdrop-blur-sm">
              <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#243150]/30 to-[#2f5fd0]/30 border border-[#3b6fe0]/20 flex items-center justify-center relative">
                  <span className="text-[#3b6fe0] font-bold text-sm">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {activeConvo.status === 'BOT' && (
                      <span className="text-[9px] bg-[#3b6fe0]/10 text-[#3b6fe0] border border-[#3b6fe0]/20 rounded-full px-2 py-0.5 font-bold uppercase">
                        Bot
                      </span>
                    )}
                  </div>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold border transition-all duration-200 hover:-translate-y-0.5 ${
                  activeConvo.status === 'HANDOVER'
                    ...
                    : 'bg-[#3b6fe0]/10 text-[#3b6fe0] border-[#3b6fe0]/20 hover:bg-[#3b6fe0]/20'
                }`}
              >
                        ...
                        <div
                          className={`max-w-[65%] px-4 py-2.5 text-sm relative group ${
                            m.direction === 'OUTBOUND'
                              ? 'bg-gradient-to-r from-[#243150] to-[#2f5fd0] text-white rounded-2xl rounded-br-md shadow-md shadow-[#243150]/10'
            ...
            <div className="px-4 py-3 border-t border-brand-hairline bg-brand-surface">
              ...
              <div className="flex items-end gap-2">
                <div className="flex-1 relative">
                  <input
                    ref={inputRef}
                    className="w-full bg-white border border-brand-hairline rounded-2xl pl-4 pr-12 py-3.5 text-brand-ink text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#3b6fe0]/40 focus:border-[#3b6fe0]/30 transition-all"
                    value={draft}
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#243150] to-[#2f5fd0] hover:from-[#3a5264] hover:to-[#b88c6b] text-white p-3.5 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.95] disabled:opacity-30 disabled:hover:translate-y-0 shadow-lg shadow-[#243150]/20 flex-shrink-0"
                >
                  <Send size={18} />
                </button>
              </div>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center max-w-xs">
              <div className="w-20 h-20 rounded-2xl bg-[#3b6fe0]/10 border border-[#3b6fe0]/20 flex items-center justify-center mx-auto mb-5">
                <MessageSquare size={32} className="text-[#3b6fe0]/60" />
              </div>
