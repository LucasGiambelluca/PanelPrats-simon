  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0b0f1a] p-6 text-center">
      <div className="max-w-md">
        ...
        <h1 className="text-2xl font-serif font-bold text-brand-textLight mb-2">Página no encontrada</h1>
        <p className="text-brand-textMuted mb-6">La dirección que abriste no existe o cambió.</p>
        <Link
          to="/"
