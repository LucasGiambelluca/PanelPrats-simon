    ...
    <div className="min-h-screen bg-brand-ivory p-6 lg:p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-8 border-b border-brand-hairline pb-6">
          <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#284050] to-[#335f7d] flex items-center justify-center">
            <Users size={22} className="text-[#3f7ba3]" />
          </div>
          <div>
        ...
        <div className="glass-card rounded-2xl p-6 mb-8 border border-brand-hairline">
          ...
          <button onClick={create} disabled={creating} className="mt-4 flex items-center gap-2 bg-gradient-to-r from-[#284050] to-[#335f7d] text-white px-6 py-3 rounded-xl font-bold text-sm disabled:opacity-40">
        ...
        <div className="glass-card rounded-2xl border border-brand-hairline overflow-hidden">
          {loading ? (
            <div className="p-10 flex justify-center"><Loader2 size={24} className="animate-spin text-[#3f7ba3]" /></div>
          ) : list.length === 0 ? (
