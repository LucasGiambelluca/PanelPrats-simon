...
const channelConfig: Record<Channel, { label: string; icon: any; color: string }> = {
  whatsapp:  { label: 'WhatsApp',  icon: MessageCircle, color: 'bg-[#2563eb]/10 text-[#2563eb] border-[#2563eb]/20' },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8 border-b border-brand-hairline pb-6">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#1e3a8a] to-[#1d4ed8] flex items-center justify-center shadow-lg shadow-brand-secondary/10">
          ...
          <button onClick={() => { reload(); loadFlows(); }} className="text-[#1d4ed8] hover:text-brand-ink transition-colors p-2.5 rounded-xl bg-black/[0.03] border border-brand-hairline hover:bg-black/[0.06]">
            <RefreshCw size={18} />
          </button>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#1e3a8a] to-[#1d4ed8] hover:from-[#3a5264] hover:to-[#b88c6b] text-white px-7 py-3.5 rounded-xl font-bold text-sm shadow-md transition-all duration-300 hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-40 disabled:hover:translate-y-0 whitespace-nowrap"
              >
                <Plus size={16} />
                Crear Línea
              </button>
          ...
          {accounts.map((a) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#2563eb]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                <div className={`p-5 flex flex-col ${isConnecting ? '' : 'h-full'} justify-between`}>
                  <div>
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1e3a8a]/30 to-[#1d4ed8]/30 border border-brand-hairline flex items-center justify-center relative">
                          <Smartphone size={22} className="text-[#1d4ed8]" />
                  ...
                  <div className="flex gap-2 mt-4 pt-3 border-t border-brand-hairline">
                    <button
                      ...
                      className="flex items-center justify-center p-2.5 bg-black/[0.03] hover:bg-black/[0.06] text-[#1d4ed8] rounded-xl border border-brand-hairline transition-all"
                ...
                {isConnecting && (isMeta || isOfficial) && (
                  <div className="border-t border-brand-hairline bg-gradient-to-b from-[#2563eb]/5 to-transparent p-6 animate-fade-in col-span-1 md:col-span-2 lg:col-span-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <code className="block bg-brand-panel border border-brand-hairline rounded-lg px-3 py-2.5 text-[#1d4ed8] text-xs font-mono break-all">
                    ...
                    <div className="mt-4 p-3.5 bg-[#2563eb]/5 rounded-xl border border-[#2563eb]/10 text-xs text-brand-inkmuted leading-relaxed flex items-start gap-2.5">
                      <HelpCircle size={16} className="text-[#1d4ed8] flex-shrink-0 mt-0.5" />
                      <div>
                      ...
                      <div className="flex-shrink-0">
                        {connectStatus === 'connected' ? (
                          ...
                          <div className="w-60 h-60 bg-white rounded-2xl p-3 shadow-lg shadow-black/5 relative overflow-hidden flex items-center justify-center border border-brand-hairline">
                            ...
                            />
                            <div className="absolute left-3 right-3 h-[2px] bg-gradient-to-r from-transparent via-[#2563eb] to-transparent animate-scan-line" />
                          </div>
                        ) : (
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            <div key={item.step} className="flex items-center gap-3">
                              <div className="w-6 h-6 rounded-full bg-[#2563eb]/10 flex items-center justify-center flex-shrink-0 border border-[#2563eb]/20">
                                <span className="text-[#1d4ed8] text-[11px] font-bold">{item.step}</span>
                              </div>
        ...
        {accounts.length === 0 && (
          <div className="text-center py-24 glass-card rounded-2xl border border-brand-hairline">
            <div className="w-20 h-20 rounded-2xl bg-black/[0.03] border border-brand-hairline flex items-center justify-center mx-auto mb-5 text-[#1d4ed8]">
              <Smartphone size={36} />
            </div>
          ...
          <div className="glass-card rounded-2xl border border-brand-hairline max-w-lg w-full overflow-hidden shadow-2xl relative">
            ...
            <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-1">
                ...
                <input
                  className="w-full bg-white border border-brand-hairline rounded-xl px-4 py-3 text-brand-ink text-sm focus:outline-none focus:ring-2 focus:ring-[#2563eb]/30"
                  value={editName}
              ...
              <div className="space-y-1">
                ...
                <select
                  className="w-full bg-white border border-brand-hairline rounded-xl px-3 py-3 text-brand-ink text-sm focus:outline-none focus:ring-2 focus:ring-[#2563eb]/30 appearance-none cursor-pointer"
                  value={editFlowId || ''}
              ...
              <div className="space-y-3 border-t border-brand-hairline pt-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Bot size={15} className="text-[#1d4ed8]" />
                  ...
                  <button
                    ...
                    className={`relative w-11 h-6 rounded-full transition-colors ${editAiEnabled ? 'bg-[#1d4ed8]' : 'bg-black/[0.12]'}`}
                  ...
                  <div className="space-y-3 animate-fade-in">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="space-y-1">
                        ...
                        <input
                          type="password"
                          className="w-full bg-white border border-brand-hairline rounded-xl px-4 py-2.5 text-brand-ink text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2563eb]/30"
                          placeholder="sk-..."
                          value={editAiApiKey}
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        className="w-full bg-white border border-brand-hairline rounded-xl px-4 py-2.5 text-brand-ink text-sm min-h-[70px] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2563eb]/30 resize-none leading-relaxed"
            ...
            <div className="flex gap-3 p-5 border-t border-brand-hairline bg-brand-panel justify-end">
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-gradient-to-r from-[#1e3a8a] to-[#1d4ed8] hover:from-[#3a5264] hover:to-[#b88c6b] text-white px-6 py-2.5 rounded-xl font-bold text-xs shadow-md transition-all duration-300 disabled:opacity-40"
              >
                {saving ? (
                  <>
