          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#304352] to-[#a57b5a] hover:from-[#3a5264] hover:to-[#b88c6b] text-white px-7 py-3.5 rounded-xl font-bold text-sm shadow-md transition-all duration-300 hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-40 disabled:hover:translate-y-0 whitespace-nowrap"
              >
                <Plus size={16} />
                Crear Línea
              </button>
          ...
          <div className="glass-card rounded-2xl border border-brand-hairline max-w-lg w-full overflow-hidden shadow-2xl relative">
            ...
            <div className="flex gap-3 p-5 border-t border-brand-hairline bg-brand-panel justify-end">
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-gradient-to-r from-[#304352] to-[#a57b5a] hover:from-[#3a5264] hover:to-[#b88c6b] text-white px-6 py-2.5 rounded-xl font-bold text-xs shadow-md transition-all duration-300 disabled:opacity-40"
              >
                {saving ? (
                  <>
