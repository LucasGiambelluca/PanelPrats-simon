...
import { MessageSquare, HelpCircle, GitFork, BarChart2, Store, ArrowRightCircle, UploadCloud, FileText, PauseCircle, Clock, ChevronLeft, ChevronRight, AlertTriangle, Image, Search, Brain, Mic, Bot, Zap, Database, Scissors, Spline, MousePointerClick } from 'lucide-react';
